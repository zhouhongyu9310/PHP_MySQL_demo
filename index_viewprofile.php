...
<body>
  <header>
    ...
    <ul>
    <li>  <a href="<?php echo 'viewprofile.php?user='.$_SESSION['login_user'] ?>" onclick="window.open(this.href, 'targetWindow','width=800px,height=600px'); return false;"> View Profile </a></li>
  ...
  <p> Main Menu </p>
  <table>
  <tr><td><a href="<?php echo 'viewprofile.php?user='.$_SESSION['login_user'] ?>" onclick="window.open(this.href, 'targetWindow','width=800px,height=600px'); return false;"> View Profile </a></td></tr>
  ...
  <form class="modal-content animate" action="./register.php" method="post" style="width:60%; overflow:true;">
	 ...
	 <div class="container">
		...
		<input type="text" placeholder="Email Address" name="email" style="margin-left:2%;width:97%;" required>
		...
		<input type="text" placeholder="Zip Code" name="zip" style="width:32%" required>	
	</div>
	...
	<div class="container">
		...
		<input type="text" placeholder="Credit Card #" name="ccnumber" style="margin-left:1%;width:47.5%;" required>
		...
		<input type="text" placeholder="CVC" name="cvc" style="width:32%" required>
  ...
  <div class="container">
   ...
   <button name="submit" type="submit" style="border-radius: 0px;border:0;margin-left:-1%;height:40px;display:inline-block"> Search </button> 
   <div style="display:block; padding-top:10px">  </div>
   <p style="margin-left:3%; width:52%;display:inline-block"> <b> Type: </b></p>
   <p style="width:20%;display:inline-block"> <b> Power Source: </b></p> 
   <p style="width:20%;display:inline-block"> <b> Sub-Type: </b></p>
   <div style="display:block; padding-top:10px">  </div>
   <input class='type' type="radio" name="type" value='all' style="margin-left:3%;" required> <label style="margin:auto 5px"> All </label>
   ...
   <select class='powersource' name='powersource' style="width:18%; height:35px;margin-left:3%" required> </select>
   <select class='subtype' name='subtype' style="width:18%; height:35px;margin-left:2%" required>  </select>
  </div>
  </form>
  <!-- Return Information -->
<?php
...
<div id="reservationtask" class="modal">
  ...
  <div class="container">
    ...
    <p style="width:20%;display:inline-block"> <b> Sub-Type: </b></p>
    <div style="display:block; padding-top:10px">  </div>
    <input required class='type' type="radio" name="type" value='all' style="margin-left:3%;" > <label style="margin:auto 5px"> All </label>
    <input class='type' type="radio" name="type" value='Hand'> <label style="margin:auto 5px"> Hand Tool </label>
    <input class='type' type="radio" name="type" value='Garden'> <label style="margin:auto 5px"> Gardon Tool </label>
   <input class='type' type="radio" name="type" value='Ladder'> <label style="margin:auto 5px"> Ladder </label>
    <input class='type' type="radio" name="type" value='Power'> <label style="margin:auto 5px"> Power Tool </label>
    <select required class='powersource' name='powersource' style="width:18%; height:35px;margin-left:3%"> </select>
    <select required class='subtype' name='subtype' style="width:18%; height:35px;margin-left:2%">  </select>
  </div>
  </form>
<!-- Return Information -->
<?php
...
echo "<p style='width:20%;display:inline-block'> $total_rental </p>";
echo "<p style='width:20%;display:inline-block'> $total_deposit </p>";
echo "</div>";
echo "<div class='container' style='padding:10px 16px;'> </div>";
if(!$res_id){
  ...
  <div id="viewprofile" class="modal">
      ...
      <?php
		...
		while($row = $res->fetch()) {
			...
			echo "<p style='font-size:1.1vw;width:10%;display:inline-block;vertical-align:top;'> $row[3] </p>";
			echo "<p style='font-size:1.1vw;width:10%;display:inline-block;vertical-align:top;'> $row[4] </p>";
			$numd = ceil((strtotime($row[2]) - strtotime($row[1]))/(60*60*24));
			echo "<p style='font-size:1.1vw;width:4%;display:inline-block;vertical-align:top;'> $numd </p>";
			echo "<p style='font-size:1.1vw;width:10%;display:inline-block;text-align:right;vertical-align:top;'> $total_dep </p>";
			echo "<p style='font-size:1.1vw;width:10%;display:inline-block;text-align:right;vertical-align:top;'> $total_ren </p>";
			echo "</div>";
		}
